package SPSE2::Util::ConvertSPSE2ToDoDomain;

# FIXME: This is almost verbatim from Verber::Federated::PSEx3.  Needs
# to be fixed into its own thing to export .do domains.
