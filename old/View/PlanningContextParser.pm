package SPSE2::GUI::Tab::View::PlanningContextParser;
...
use Class::MethodMaker
  ...
  [
   ...
   qw / RegisteredWorldNames MyTempAgent MyDomain MyProblem MyLight
	...
	MyDateManip EntryData MyGraph DependencyGraph MyClient Data
	Goals /
...
sub GeneratePlan {
  my ($self,$preference) = @_;
  system "/var/lib/myfrdcsa/codebases/internal/verber/verber -w psex2";
}
